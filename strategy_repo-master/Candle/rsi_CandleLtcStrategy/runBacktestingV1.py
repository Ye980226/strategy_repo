...
if __name__ == '__main__':
    ...
    print(setting[0])
    # Bar回测
    setting[0]['symbolList'] = ["ltc.usd.q:okef"]
    ...
    mp.set_line(line=chartDf[['Roc','Roc_Value','minus_roc']], colors={"Roc":"blue","Roc_Value":"red","minus_roc":"red"}, pos=1)
    # mp.set_line(line=chartDf[['RocValue']], colors={"RocValue":"blue"}, pos=2)
    mp.show()
