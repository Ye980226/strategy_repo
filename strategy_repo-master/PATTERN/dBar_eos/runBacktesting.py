...
from StrategyDoubleBar import StrategyTest
import json
import logging
...
if __name__ == '__main__':
    ...
    engine.setStartDate('20180602 08:00:00',initHours=10)   
    engine.setEndDate('20190522 06:00:00')
    ...
    engine.initStrategy(StrategyTest, d)
    # 开始跑回测
