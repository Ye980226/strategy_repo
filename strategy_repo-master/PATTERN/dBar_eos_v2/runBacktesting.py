...
import pandas as pd
import os
from StrategyDoubleBarV2 import StrategyDoubleBarV2 as StrategyClass
import json
import logging
...
if __name__ == '__main__':
    ...
    # candel=pd.DataFrame([bar.__dict__ for bar in engine3month.backtestData])
    # trade_file = os.path.join(engine3month.logPath, "交割单.csv")
    # trades = htmlplot.read_transaction_file(trade_file)
    # mp = htmlplot.MultiPlot(os.path.join(engine3month.logPath, "transaction.html"))
