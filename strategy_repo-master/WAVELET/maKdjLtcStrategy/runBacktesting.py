...
if __name__ == '__main__':
    from maKdjStrategyT1 import maKdjStrategy
    # 创建回测引擎
    ...
    engine.setStartDate('20190201 23:00:00',initHours=10)   
    engine.setEndDate('20190509 23:00:00')

    # 设置产品相关参数
    engine.setCapital(1000)  # 设置起始资金，默认值是1,000,000
    contracts = [{
                    "symbol":"ltc.usd.q:okef",
                    "size" : 1, # 每点价值
    ...
    engine.initStrategy(maKdjStrategy, setting[0])
    ...
    mp.set_line(line=chartDf[['trendMa']], colors={"trendMa": "red"}, pos=0)
    mp.set_line(line=chartDf[['k', 'd']], colors={"k": "red", "d": "green"}, pos=1)
    mp.show()
