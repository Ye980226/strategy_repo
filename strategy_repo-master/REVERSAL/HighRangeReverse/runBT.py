...
def runBacktesting(strategyClass, settingDict,
    ...
    htmlplot.showTransaction(engine, frequency="1m")


from Strategy2 import StrategyHighRangeRev
...
runBacktesting(StrategyHighRangeRev, setting,
               '20190101 00:00:00', '20190531 23:59:00',
               contracts=contracts)
