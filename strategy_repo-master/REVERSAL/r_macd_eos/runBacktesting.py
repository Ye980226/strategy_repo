...
if __name__ == '__main__':
    from Strategy_MACD import StrategyADX_macd
    # 创建回测引擎
    ...
    engine.setEndDate('20190516 06:00:00')
    ...
    engine.initStrategy(StrategyADX_macd, d)
    ...
    # mp = htmlplot.MultiPlot("test.html")
    # Candle = candle.set_index('datetime')[start:end].reset_index(drop=False)
    # mp.set_candle(Candle,'15m')
    # mp.set_line(line=dilog[['macd','macdSignal']])
