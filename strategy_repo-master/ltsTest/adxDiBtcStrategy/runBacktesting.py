...
if __name__ == '__main__':
    from adxDiBtcStrategy516 import adxDiStrategy
    # 创建回测引擎
    ...
    engine.setStartDate('20190401 23:00:00',initHours=10)   
    engine.setEndDate('20190530 23:00:00')

    # 设置产品相关参数
    engine.setCapital(100)  # 设置起始资金，默认值是1,000,000
    contracts = [{
                    "symbol":"btc.usd.q:okef",
                    # "symbol":"btc_quarter:OKEX",
                    "size" : 1, # 每点价值
    ...
    engine.initStrategy(adxDiStrategy, setting[0])
