...
if __name__ == '__main__':
    from macd002_Strategy import macd002_Strategy
    ...
    engine.setStartDate('20181117 10:00',initHours=10)   
    engine.setEndDate('20181124 12:00')
    # 设置产品相关参数
    engine.setCapital(100000)  # 设置起始资金，默认值是1,000,000
    engine.setSlippage(0.0002)     # 股指1跳
    ...
    engine.initStrategy(macd002_Strategy, d)
