...
if __name__ == '__main__':
    from ARPSYMaStrategy import ARPSYMaStrategy
    ...
    engine.setStartDate('20180908 06:00',initHours=50)
    engine.setEndDate('20181208 08:00')
    # 设置产品相关参数
    ...
    engine.initStrategy(ARPSYMaStrategy, d)
