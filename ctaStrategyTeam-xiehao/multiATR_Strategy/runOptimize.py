...
from EOS_Mas_Strategy import Mas_Strategy
...
# addParameter-----------------------------------------------------------------------------------------
    ...
    #setting.addParameter('atrPeriod', 10, 101, 10)
    setting.addParameter('up_value', 3, 38, 5)
    setting.addParameter('down_value', 3, 38, 5)
    #setting.addParameter('window1', 11, 26, 3)
    #setting.addParameter('window2', 20, 62, 7)
    # setting.addParameter('profitMultiplier', 2, 4, 1)
    #
    # arrayWindow = 100
    # breakWindow = 50
    # secondWindow = 50
...
if __name__ == '__main__':
    ...
    bestParameter = runOptimize(Mas_Strategy, {'symbolList': ['EOSUSDT:binance']} , '20180601 12:00', '20180918 12:00', 0.002, 5/10000, 100)
