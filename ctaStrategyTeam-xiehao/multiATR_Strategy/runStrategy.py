...
from multiATR_Strategy import multiATR_Strategy
...
if __name__ == '__main__':
    performanceReport, tradeReport = \
        runBacktesting(multiATR_Strategy, {'symbolList': ['EOSUSDT:binance',
                                                            # 'eth_quanter:OKEX'
                                                            ]},
                       '20180104 12:00', '20180925 12:00', 100, 0, 5/10000)
    tradeReport.to_excel('MasReport.xlsx')