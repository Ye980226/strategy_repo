...
if __name__ == '__main__':
    from Mas003_Strategy import Mas_Strategy
    ...
    engine.setStartDate('20180610 06:00',initHours=10)   
    engine.setEndDate('20181024 08:00')
    # 设置产品相关参数
    ...
    engine.initStrategy(Mas_Strategy, d)
