...
# addParameter-----------------------------------------------------------------------------------------
    ...
    # setting.addParameter('breakWindow', 30, 61, 10)
    # setting.addParameter('secondWindow', 40, 81, 10)
    # setting.addParameter('holdTime', 90, 111, 10)
    # setting.addParameter('atrMultiplier', 3, 8, 2)
...
if __name__ == '__main__':
    ...
    bestParameter = runOptimize(SecondBreakStrategy, {'symbolList': ['EOSUSDT:binance']} , '20180601 12:00', '20180918 12:00', 0.002, 5/10000, 100)
