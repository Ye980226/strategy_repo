...
########################################################################
class macdEngulfing60Strategy(CtaTemplate):
    author = 'ChannelCMT'
    # 策略参数
    ...
    # 风控参数
    stopLossPct = 0.025; protectPct=0.03
    takeProfitFirstPct = 0.04; takeProfitSecondPct = 0.06
    holdHour =24;expectReturn = 0.001
    stopControlTime = 4
    ...
    def onInit(self):
        ...
        self.stopProtect = {s: 0 for s in self.symbolList}
...
# --------------------------------------------------------------------------
    ...
    def on60MinBar(self, bar):
        ...
        macd, macdSignal, macdHist = ta.MACD(am60.close)
    ...
    def on30MinBar(self, bar):
        ...
        advShort = ta.MA(am30.volume,self.advShortPeriod)
        advLongDelay = ta.MA(am30.volume, self.advLongDelayPeriod)[:-self.advShortPeriod]*self.advMultiper
        ...
        # candleSignal
        ENGULFING = ta.CDLENGULFING(am30.open, am30.high, am30.low, am30.close)
